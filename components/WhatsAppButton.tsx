...
export function WhatsAppButton() {
  return (
    <Link
      ...
      className={`fixed right-4 z-50 inline-flex items-center gap-2 rounded-full ${brandClasses.accentBg} shadow-lg shadow-black/30 transition hover:brightness-95 bottom-[calc(1rem+env(safe-area-inset-bottom))] size-12 justify-center px-0 text-sm font-semibold sm:right-5 sm:bottom-[calc(1.25rem+env(safe-area-inset-bottom))] sm:size-auto sm:px-4 sm:py-3`}
    >
      <MessageCircleMore className="size-5 sm:size-4" />
